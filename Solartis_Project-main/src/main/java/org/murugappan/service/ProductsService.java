...
public class ProductsService {
    ...
    public void addProduct(){
        ...
        pdi.addProducts(pd.productdetails.get("ProductName"),pd.productdetails.get("Description"),Integer.parseInt(pd.productdetails.get("CostPrice")),Integer.parseInt(pd.productdetails.get("SellingPrice")),Integer.parseInt(pd.productdetails.get("Stock")));
